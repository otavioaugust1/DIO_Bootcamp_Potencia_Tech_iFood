...
incluindo se o prato é vegano ou não (usando as opções "s" para sim e "n" para não) e a quantidade de calorias. Ao final, 
...
Pedido X: NOME_DO_PRATO (EH_VEGANO?) - YYY calorias, onde "X" é o número do pedido, "NOME_DO_PRATO" é o nome do prato, "EH_VEGADO?" indica se o prato é vegano (escrever "Vegano" ou "Nao-vegano"), 
...
for i in range(1, numPedidos + 1):
    ...
    # Converte a entrada para lowercase e verifica se é "s" para definir se é vegano
    ehVegano = input().lower() == "s" 
    
    
    # Determina o tipo do prato com base em ehVegano
    if ehVegano:
        tipo = "Vegano"
    else:
        tipo = "Nao-vegano"
